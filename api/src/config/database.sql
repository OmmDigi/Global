...
ALTER TABLE enquiry ADD COLUMN IF NOT EXISTS status INT DEFAULT 0;
ALTER TABLE enquiry ADD COLUMN IF NOT EXISTS created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP;

ALTER TABLE enquiry ADD COLUMN IF NOT EXISTS address TEXT;
ALTER TABLE enquiry ADD COLUMN IF NOT EXISTS age INT;
ALTER TABLE enquiry ADD COLUMN IF NOT EXISTS gender VARCHAR(20);
ALTER TABLE enquiry ADD COLUMN IF NOT EXISTS education_qualification VARCHAR(255);

CREATE TABLE IF NOT EXISTS enquiry_courses (
    id SERIAL PRIMARY KEY,

    enquiry_id BIGINT REFERENCES enquiry(id) ON DELETE CASCADE,
