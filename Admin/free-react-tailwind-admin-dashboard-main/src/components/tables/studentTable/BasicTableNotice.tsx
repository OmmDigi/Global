          ...
          <TableBody className="divide-y divide-gray-100 dark:divide-white/[0.05]">
            {tableData.map((order) => (
              <TableRow key={order.id}>
                ...
                <TableCell className="px-4 py-3 text-gray-500 text-start text-theme-sm dark:text-gray-400">
                  <div className="flex -space-x-2">12/2/2020</div>
                </TableCell>
                <TableCell className="px-4 py-3 text-red-500 text-start text-theme-sm dark:text-red-400">
                  <div className="flex -space-x-2">{order.budget}</div>
                </TableCell>
      ...
      {showModal && selectedMessage && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-80">
          <div className="bg-white p-6 rounded-lg max-w-md w-full shadow-lg">
            ...
            <p>
              <strong>Name:</strong> {selectedMessage.user.name}
            </p>
            <p>
              <strong>Project Name:</strong> {selectedMessage.projectName}
            </p>
            <p>
              <strong>Budget:</strong> {selectedMessage.budget}
            </p>
            <p>
              <strong>Date:</strong> 12/2/2020
            </p>
