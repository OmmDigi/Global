...
export default function NavComp() {
  ...
  const { isScrolling } = useScrollChecker();
            ...
            <div
              className={`${
                isScrolling
                  ...
                  : "max-h-full transition-transform duration-500"
              } `}
            >
              <div className="hidden lg:flex justify-between pb-5 pt-3 pl-8 pr-8">
                {navigation3.map((item, index) => (
                  ...
                  >
                    ...
                    />
                    <div
                      className={`ml-2 flex flex-col justify-center items-center ${
                        index === 2 ? "  rounded-2xl " : ""
                      } `}
                    >
                      {index === 2 && (
                  ...
                  >
                    ...
                    {isOpen && (
                      <div
                        ...
                        className=" absolute z-10 mt-2 font-normal bg-white divide-y divide-gray-100  shadow-sm w-60 dark:bg-gray-700 dark:divide-gray-600"
                      >
                        <div className="py-1">
                          <Link
