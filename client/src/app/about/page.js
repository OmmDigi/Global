        ...
        <div id="about" className="w-full bg-gray-100 py-12 px-4">
            ...
            <div>
              ...
              <div className="mt-6 text-gray-700 text-base space-y-4">
                <p>
                  ...
                  industry-aligned education, fostering success in a competitive
                  marketplace. Committed to academic excellence, our institute
                  maintains rigorous standards and quality. Contact us to learn
                  more about us.
                </p>
                <p>
                  Our vision is to be a premier institution in India for
                  technical education, renowned for outstanding faculty,
                  advanced facilities, and innovative programs. We aim to create
                  an enriching learning environment that empowers students to
                  excel. With a focus on social responsibility, we cultivate
                  graduates who are proficient in their field and contribute
                  positively to society, fostering a community dedicated to
                  societal change.
                </p>
                <p>
                  Based in India, Global Technical Institute (GTI) is a leading
                  technical education hub offering diverse courses and training
                  programs. Our focus is on empowering individuals with
                  practical skills and knowledge essential for workforce
                  success. Specializing in areas like Teacher Training, Nursing,
                  and Lab Technician Training, GTI distinguishes itself with
                  hands-on learning in state-of-the-art labs. Learn more about
                  us and our specialty
                </p>
          ...
          <div  className="mt-6 text-gray-700">
            <p>
              ...
              personalized guidance and soft skills training alongside technical
              expertise. Recognized by industry bodies, our programs feature
              partnerships with companies for internship opportunities.
            </p>
            <p>
              ...
              careers. Explore our offerings and track record of job placements.
            </p>
          </div>
        </div>
      </section>
