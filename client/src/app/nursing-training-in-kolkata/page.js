      ...
      <section className="py-12 px-4 bg-gray-50 text-gray-800">
        <div className="max-w-5xl mx-auto space-y-6">
          ...
          <p>
            ...
            Technical Institute is the perfect choice for you. With a strong
            focus on practical skills and comprehensive theoretical knowledge,
            we offer a rewarding learning experience that prepares you for a
            successful career in patient care. As Kolkata’s leading{" "}
            <Link
            ...
            , we are committed to delivering quality education and shaping
          ...
          <p>
            ...
            course designed to equip you with the skills and knowledge required
            in the healthcare industry. Upon successful completion, you will be
          ...
          <p>
            ...
            recognition. Our course is promoted by the Government of India
            through the Bharat Sevak Samaj (BSS), ensuring the highest education
            standards. Additionally, our institute holds ISO certification,
            further validating our commitment to quality training. We are also
            an affiliated partner of the{" "}
            <strong>National Skill Development Corporation (NSDC)</strong>,
            which opens up various career opportunities for our students.
          </p>
          ...
          <p>
            ...
            September. Each session spans two years, allowing you to complete
            the course at your own pace. We understand the importance of
            balancing your studies with other commitments, so we offer two
            weekly classes, ensuring flexibility and convenience for our
            students.
          </p>
          ...
          <p>
            ...
            grooming sessions to enhance your overall growth and
            professionalism. These sessions focus on developing communication
            skills, building self-confidence, and presenting yourself
            effectively in a professional healthcare setting.
          </p>
          ...
          <p>
            ...
            patient care. Our comprehensive ANM course, recognized
            certifications, and dedicated faculty members ensure you receive the
            best education and training. Take the first step today by enrolling
            in our esteemed nursing training institute in{" "}
            <Link
