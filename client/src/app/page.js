...
export default function Example() {
  return (
    <>
      <Navbar />
      <div className=" grid grid-cols-1 h-auto bg-gray-300 md:grid-cols-2 gap-50 items-center">
        <div className="w-12/12 ml-10">
          <div className="text-[#a85502] hidden lg:flex flex-col">
          ...
          <div className="mt-20">
            ...
            <h1 className="font-bold text-[#f71111] text-3xl mt-5">
              Unlock Your Potential with Global Technical Institute{" "}
            </h1>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center py-10 bg-gray-300">
              <div className="flex flex-col items-center">
                <div className="text-4xl font-extrabold text-blue-600">15+</div>
      ...
      <div className="flex justify-center ">
        <section className="bg-blue-500 py-8 p-10 w-12/12    ">
      ...
      <div className=" bg-gray-300">
        <div className="w-full flex justify-start items-start px-4 md:px-8 py-6">
          <div className="w-full max-w-screen-xl  flex justify-start items-start ">
            <Carousel
              swipeable={true}
              draggable={true}
              // autoPlay={true}
          ...
          <div>
            ...
            <div className="mt-6 text-gray-700 text-base space-y-4">
              <p>
                ...
                student has unique strengths and weaknesses. That’s why we offer
                a personalized approach to teacher training in Kolkata. Our
                faculty takes the time to understand each student’s needs and
                tailors the curriculum to help them achieve their goals.
              </p>
              <p>
              ...
              <p className="text-sm text-gray-600 mt-4">
                GITA CHOWDHURY EDUCATION SOCIETY was formed and registered under
                the West Bengal Society Registration Act of 1961 vide
                Registration No. S/IL/95693 and registered with The Directorate
                of Micro & Small Scale Industry Enterprises, Government of West
                Bengal vide Registration No. 3459/DIC/KOL.
              </p>
              <div className="mt-6">
                <Link
                  href="/about"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="text-center p-6 border rounded-lg shadow-md bg-gray-50">
              ...
              <blockquote className="text-gray-700 space-y-1 text-sm text-left">
                <p>
                  Welcome to Global Technical Institute, if you’re looking for a
                  reputable teacher training institute in Kolkata, look no
                  further than GTI. Our institution is committed to providing
                  exceptional training to aspiring educators who want to make a
                  difference in the lives of their students.
                </p>
                <p>
                  Our experienced faculty members bring a wealth of knowledge
                  and expertise to the classNameroom, ensuring that our students
                  receive the best possible education and training. We offer a
                  range of programs and courses designed to meet the needs of
                  educators at every level, from beginner to advanced.
                </p>
                <p>
                  Whether you’re interested in learning the latest teaching
                  techniques or enhancing your skills in a particular subject
                  area, our teachers training institute in Kolkata can help you
                  achieve your goals. Join us today and discover the many
            ...
            <div className="text-center p-6 border rounded-lg shadow-md bg-gray-50">
              ...
              <blockquote className="text-gray-700 space-y-1 text-sm text-left">
                ...
                <p>
                  ...
                  environment that fosters growth and development. We also offer
                  practical training and real-world experience through our
                ...
                <p>
                  ...
                  resources and opportunities needed to succeed in your career.
                  Join us today and take the first step towards a fulfilling and
        ...
        <li className="flex text-center space-x-3">
          ...
          <div className="flex flex-col text-center">
            ...
            <div className="text-sm text-gray-600 mt-1">
              ...
              Based on <span className="font-semibold text-gray-700">463</span>{" "}
              User Reviews
            </div>
          </div>
        </li>
          ...
          <div className="w-full md:w-1/2 text-center md:text-left space-y-6">
            ...
            <div className="max-w-[90%] mx-auto text-gray-200 text-left space-y-4">
              <p>
                ...
                specialties that set it apart from other technical education and
                training providers. Some of the key USPs of Global Technical
                Institute include:
              </p>
              <p>
                Global Technical Institute makes it an excellent choice for
                students who want to receive high-quality technical education
                and training that will prepare them for success in their chosen
                field.
              </p>
            </div>
          ...
          <div className="w-full md:w-[40%] mt-10 md:mt-0 md:ml-10">
            <ul className="space-y-4 text-gray-100 font-bold">
              ...
              <li>
                <h4 className="text-lg font-medium">
                  {" "}
                  <span className="mr-2 text-lg"> &#9679;</span> Career Services
                </h4>
              </li>
            </ul>
          </div>
